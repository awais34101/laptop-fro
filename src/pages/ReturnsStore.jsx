    ...
    >
      ...
      >
        <Box>
          ...
          >
            Returns Management (Store 2)
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Track and manage all Store 2 return invoices
          </Typography>
        </Box>
        <Button 
          variant="contained" 
                ...
                <TableBody>
                  {(ret.items && ret.items.length > 0) ? ret.items.map((item, idx) => (
                    ...
                    >
                      <TableCell sx={{ fontWeight: 600, color: '#1a237e' }}>
                        {item.item?.name || getItemName(item.item?._id || item.item) || item.item}
                      </TableCell>
                      <TableCell>
                        <Box 
                          sx={{ 
                  ...
                  {ret.items && ret.items.length > 0 && (
                    <TableRow>
                      ...
                      >
                        {getTotalValue(ret).toFixed(2)} AED
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
